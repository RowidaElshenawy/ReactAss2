  ...
  return (
    <>
     {error ? <div className='h-screen'><div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 w-full" role="alert">
              {error}
            </div> </div> :loader? <div className='h-screen flex justify-center items-center '><CircleLoader color='green' size={100}/></div> : <div className='lg:flex lg:flex-wrap lg:justify-between lg:items-start  '>
        ...
        <div className='bg-white p-3 lg:w-[32%] mt-12'>
          ...
          <ul>
            {mealDetails.strMeasure1? <li className='border-b-2 border-gray-500 mb-2 p-1 flex justify-between'>
              <h4 className=''>{mealDetails.strIngredient1}</h4>
              <span>{mealDetails.strMeasure1}</span>
            </li>:""}
            {mealDetails.strIngredient2?<li className='border-b-2 border-gray-500 mb-2 p-1 flex justify-between'>
              <h4 className=''>{mealDetails.strIngredient2}</h4>
              <span>{mealDetails.strMeasure2}</span>
            </li>:""} 
            {mealDetails.strMeasure3? <li className='border-b-2 border-gray-500 mb-2 p-1 flex justify-between'>
              <h4 className=''>{mealDetails.strIngredient3}</h4>
              <span>{mealDetails.strMeasure3}</span>
            </li>:""}
            {mealDetails.strMeasure4?<li className='border-b-2 border-gray-500 mb-2 p-1 flex justify-between'>
              <h4 className=''>{mealDetails.strIngredient4}</h4>
              <span>{mealDetails.strMeasure4}</span>
            </li>:""}
            {mealDetails.strIngredient5?<li className='border-b-2 border-gray-500 mb-2 p-1 flex justify-between'>
